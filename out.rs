...
impl PingPong {
    const __PINGPONG__CONST_CHECK_UNIQUE_SERVICES_IDS: () = if !::overwatch_rs::utils::const_checks::unique_ids(
        &[
            <PingService as ::overwatch_rs::services::ServiceData>::SERVICE_ID,
            <PongService as ::overwatch_rs::services::ServiceData>::SERVICE_ID,
        ],
    ) {
        ::core::panicking::panic(
            "assertion failed: ::overwatch_rs::utils::const_checks::unique_ids(&[<PingService as\n                    ::overwatch_rs::services::ServiceData>::SERVICE_ID,\n                <PongService as\n                    ::overwatch_rs::services::ServiceData>::SERVICE_ID])",
        )
    };
}
pub struct PingPongServiceSettings {
    pub ping: <PingService as ::overwatch_rs::services::ServiceData>::Settings,
    pub pong: <PongService as ::overwatch_rs::services::ServiceData>::Settings,
}
#[automatically_derived]
...
impl ::overwatch_rs::overwatch::Services for PingPong {
    type Settings = PingPongServiceSettings;
    fn new(
        settings: Self::Settings,
        overwatch_handle: ::overwatch_rs::overwatch::handle::OverwatchHandle,
    ) -> ::std::result::Result<Self, ::overwatch_rs::DynError> {
        let Self::Settings { ping: ping_settings, pong: pong_settings } = settings;
        let app = Self {
            ping: {
                let manager = ::overwatch_rs::services::handle::ServiceHandle::<
                    PingService,
                >::new(ping_settings, overwatch_handle.clone())?;
                manager
            },
            pong: {
                let manager = ::overwatch_rs::services::handle::ServiceHandle::<
                    PongService,
                >::new(pong_settings, overwatch_handle.clone())?;
                manager
            },
        };
    ...
    fn start_all(
        ...
        ::overwatch_rs::overwatch::ServicesLifeCycleHandle,
        ::overwatch_rs::overwatch::Error,
    > {
        ::std::result::Result::Ok(
            [self.ping.service_runner().run()?, self.pong.service_runner().run()?]
                .try_into()?,
        )
    }
    fn start(
    ...
    ) -> Result<(), ::overwatch_rs::overwatch::Error> {
        match service_id {
            <PingService as ::overwatch_rs::services::ServiceData>::SERVICE_ID => {
                self.ping.service_runner().run()?;
                ::std::result::Result::Ok(())
            }
            <PongService as ::overwatch_rs::services::ServiceData>::SERVICE_ID => {
                self.pong.service_runner().run()?;
                ::std::result::Result::Ok(())
            }
            service_id => {
                ::std::result::Result::Err(::overwatch_rs::overwatch::Error::Unavailable {
                    service_id,
                })
            }
        }
    ...
    fn request_relay(
        &mut self,
        service_id: ::overwatch_rs::services::ServiceId,
    ) -> ::overwatch_rs::services::relay::RelayResult {
        match service_id {
            <PingService as ::overwatch_rs::services::ServiceData>::SERVICE_ID => {
                ::std::result::Result::Ok(
                    ::std::boxed::Box::new(
                        self
                            ...
                            .relay_with()
                            .ok_or(
                                ::overwatch_rs::services::relay::RelayError::AlreadyConnected,
                            )?,
            ...
            service_id => {
                ::std::result::Result::Err(::overwatch_rs::services::relay::RelayError::Unavailable {
                    service_id,
                })
            }
        }
    ...
    fn request_status_watcher(
        &self,
        service_id: ::overwatch_rs::services::ServiceId,
    ) -> ::overwatch_rs::services::status::ServiceStatusResult {
        {}
        ...
        match (move || {
            ...
            if false {
                let __tracing_attr_fake_return: ::overwatch_rs::services::status::ServiceStatusResult = loop {};
            ...
            {
                {
                    match service_id {
                        ...
                        service_id => {
                            ::std::result::Result::Err(::overwatch_rs::services::status::ServiceStatusError::Unavailable {
                                service_id,
                            })
                        }
                    }
            ...
            Err(e) => {
                {
                    ...
                    static __CALLSITE: ::tracing::callsite::DefaultCallsite = {
                        static META: ::tracing::Metadata<'static> = {
                            ::tracing_core::metadata::Metadata::new(
                                "event examples/ping_pong/src/main.rs:17",
                                "ping_pong",
                                tracing::Level::ERROR,
                                ::tracing_core::__macro_support::Option::Some(
                                    "examples/ping_pong/src/main.rs",
